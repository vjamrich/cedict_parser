...
https://github.com/marcanuy/cedict_utils/tree/master
"""
...
from lib.decode_meanings import decode_meanings
from lib.decode_pinyin import decode_pinyin
...
class CedictEntry:  # pylint: disable=too-few-public-methods
    ...
    def make(cls, line):
        ...
        keywords = dict(
            meanings=decode_meanings(line.partition("/")[2]
                                     .replace('"', "'")
                                     .rstrip("/")
                                     .strip()
                                     .split("/")),
            ...
            pinyin=decode_pinyin(line.partition("[")[2].partition("]")[0]),
            raw_line=line,
        )
        return cls(**keywords)
